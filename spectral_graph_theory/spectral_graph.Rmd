...
header-includes:
- \usepackage{titling}
- \pretitle{\begin{center}\LARGE\includegraphics[width=12cm]{nsf.png}\\[\bigskipamount]}
...
Using the second and third eigenvectors of the adjacency matrix as cartesian coordinates for each node, we can plot the G with this layout to see that it is planar. 
```{r spectral_drawing}
v2<-vectors[,2]
v3<-vectors[,3]
